...
{    
    ...
    [RankColumn]
    public class ArrayExtremumBenchmark
    {
        ...
        private ArrayExtremumTask? task;

        [GlobalSetup]
        public void Setup()
        {
            task = new ArrayExtremumTask(N, 1_000_000);
            task.Setup();
        }

        [Benchmark(Baseline = true, Description = "Sequential Extremum")]
